...
public class StringBuffer_index_replace_subSquence_reverse {
public static void main(String []argu){
   StringBuffer sb1=new StringBuffer("Akash Shingade");
   ...
   System.out.println("insert ZZZ in sb1 :"+sb1.insert(12,"ZZZ"));
	...
	System.out.println("\n*********************replace********************");
   StringBuffer sb2=new StringBuffer("Computer Engg.");
   System.out.println("sb2 :"+sb2);
   System.out.println("replace of zzz in sb2 :"+sb2.replace(3,10,"zzz"));     // $$ 11. s2.replace(start,end,str); $$

	System.out.println("\n*********************subSequence********************");
   StringBuffer sb3=new StringBuffer("Akash Shingade");
